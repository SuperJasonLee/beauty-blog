"""Pipeline orchestrator: crawl → download images → generate posts for periorbital rejuvenation."""
...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Periorbital Rejuvenation Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest periorbital rejuvenation news...")
