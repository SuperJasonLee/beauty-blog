"""Pipeline orchestrator: crawl plastic-surgery subspecialties news → download images → generate bilingual posts."""
...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Plastic Surgery Subspecialties Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest plastic-surgery subspecialties news...")
    ...
    logger.info(f"[Step 2/3] Done: {len(image_url_map)} images downloaded")
