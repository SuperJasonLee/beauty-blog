"""Pipeline orchestrator for daily medical aesthetics news."""
...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Daily Medical Aesthetics News Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest daily medical aesthetics news...")
