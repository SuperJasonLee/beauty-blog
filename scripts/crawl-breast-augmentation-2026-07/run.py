"""Pipeline orchestrator: crawl breast augmentation news → download images → generate bilingual posts."""
...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Breast Augmentation Aesthetics Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest breast augmentation news...")
