"""Pipeline orchestrator: crawl → download images → generate bilingual posts."""
...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Facial Contouring & Slimming Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest facial contouring news...")
