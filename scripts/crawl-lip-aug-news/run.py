...
def run_pipeline():
    logger.info("=" * 60)
    logger.info("Lip Aesthetics News Pipeline - Starting")
    logger.info("=" * 60)

    # Step 1: Crawl
    logger.info("[Step 1/3] Crawling latest lip-aesthetics news...")
    ...
    logger.info("=" * 60)
    logger.info("Posts are marked as published (draft: false).")
    logger.info("Run 'hugo --minify' to build.")
